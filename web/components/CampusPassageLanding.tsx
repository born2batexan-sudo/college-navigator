          ...
          <main id="main" ref={publicMain} tabIndex={-1}>
            <section id="top" className="site-shell hero" aria-labelledby="hero-title">
              <div>
                ...
                <h1 id="hero-title" className="display hero-title">Your student earned the opportunity. <em>The steps that follow deserve one clear plan.</em></h1>
                <p className="lede">After submission, school-specific next steps can arrive in different places. CampusPassage is a private-preview shared plan that helps a student and caregiver organize what to review next. Official school instructions always control.</p>
