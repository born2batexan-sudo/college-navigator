    ...
    <div className="campus-page">
      ...
      <main id="main">
        <section id="top" className="hero-cinematic" aria-labelledby="hero-title">
          ...
          <div className="site-shell hero-inner">
            <div className="hero-copy">
              ...
              <p className="lede">A college choice takes shape across school pages, sponsor notices, letters, and decisions at home. Campus Passage helps a family see what matters next, without losing the source behind it.</p>
        ...
        <section id="the-journey" className="chapter chapter-passage" aria-labelledby="journey-title">
          <div className="site-shell chapter-inner">
            <div className="section-head"><div><p className="eyebrow">The whole passage</p><h2 id="journey-title" className="display">From interest to move-in.</h2></div><p>Explore schools. Submit applications. Compare aid and decisions. Prepare for a bill and a new campus. The plan is meant to keep each published step in the right student&apos;s context along the way.</p></div>
        ...
        <section id="trust" className="chapter chapter-trust" aria-labelledby="trust-title">
          <div className="site-shell chapter-inner">
            ...
            <div className="capability-groups" aria-label="What is shown and what is not yet offered">
              <section><h3>In the private preview</h3><p>Explore a fictional, read-only sample with one or two students, different kinds of updates, and source labels. This is not a live school feed.</p></section>
