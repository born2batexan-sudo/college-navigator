...
describe('owner review foundations',()=>{
 ...
 it('assistant cites only fresh certified official research for the right student',async()=>{
  ...
  await C.exec('INSERT INTO institutions(id,name,slug,domains,created_at) VALUES($1,$2,$3,$4,$5)',['school_cite','Example College','example-college',JSON.stringify(['example.edu']),now]);
